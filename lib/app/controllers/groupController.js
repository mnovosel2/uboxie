        ...
        async.waterfall([
            ...
            function(musicGroup, callback) {
                ...
                for (var i = 0; i < songsInGroup.length; i++) {
                    if (songsInGroup[i].finished == false && songsInGroup[i].key == trackKey) {
        ...
        async.waterfall([
            ...
            function(musicGroup, callback) {
                var songsInGroup = musicGroup[0].songsInGroup,
                    trackToPlay = null;
                for (var i = 0; i < songsInGroup.length; i++) {
                    if (songsInGroup[i].finished == false && songsInGroup[i].key == trackKey && songsInGroup[i].startTime == null) {
                        trackToPlay = songsInGroup[i];
                    }
                }
                if (trackToPlay) {
